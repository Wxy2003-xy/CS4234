...
\begin{enumerate}
  ...
  \item Replace $v_i \in \{0, 1\} to v^*_i \in [0,1]$, relax to LP
  \item solve
  \item Rounding 
\end{enumerate}
...
\begin{itemize}
  ...
  \[
    \sum_{x_j \in C_i} x_j + \sum_{\neg x_k \in C_i} (1 - x_k) \geq y_i
  \]
  \item Goal: maximize
\end{itemize}
Note here we dont need additional clauses to enforce structural constraints like in PL. 
